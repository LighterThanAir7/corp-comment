...
import {FeedbackItemsContext} from "../context/FeedbackItemsContextProvider.tsx";
import type {TFeedbackItem} from "./types.ts";

export function useFeedbackItemsContext() {
    const context = useContext(FeedbackItemsContext);
    if (!context) {
        throw new Error('useFeedbackItems must be used within a FeedbackItemsContextProvider');
    }
